<template>
  <div>
    ...
    <nav-bread><span slot='breads'>My Cart</span></nav-bread>
    ...
    <modal v-bind:mdShow="modalConfirm" v-on:close="closeModel">
      <p slot="message">确认要删除此条数据吗？</p>
      <div slot="btnGroup">
        <a class="btn btn--m" href="javascript:void(0)" @click='delCart'>确认</a>
        <a class="btn btn--m btn--red" href="javascript:void(0)" @click='modalConfirm=false'>关闭</a>
      </div>
    </modal>
